...
local themes = {
    ...
    Aqualina = {
        ["Accent"] = Color3.fromRGB(150, 220, 215),
        ["Window Background"] = Color3.fromRGB(32,32,32),
        ["Window Border"] = Color3.fromRGB(0,0,0),
        ["Tab Background"] = Color3.fromRGB(39,39,39),
        ["Tab Border"] = Color3.fromRGB(95,95,95),
        ["Tab Toggle Background"] = Color3.fromRGB(65,65,65),
        ["Section Background"] = Color3.fromRGB(34,34,34),
        ["Section Border"] = Color3.fromRGB(0,0,0),
        ["Text"] = Color3.fromRGB(180, 180, 190),
        ["Disabled Text"] = Color3.fromRGB(100, 100, 110),
        ["Object Background"] = Color3.fromRGB(41,41,41),
        ["Object Border"] = Color3.fromRGB(0,0,0),
        ["Dropdown Option Background"] = Color3.fromRGB(70,70,70) 
    }
}
...
function library:GetThemes()
    local themes = {"Default", "Midnight", "Aqualina"}
